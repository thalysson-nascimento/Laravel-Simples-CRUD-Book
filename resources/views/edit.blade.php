...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<p>Para cancelar atualização, <a href="{{url('/')}}">Click aqui!</a></p>
		</div>
		<br>
		<div class="row">
	...
	<div class="container">
		<div class="row">
			<form action="{{ url('/edit' , $livro->id) }}" method="post" class="col-12">
				{{ csrf_field() }}
				{{ method_field('put') }}
				<div class="form-group">
					<label for="titulo">Título:</label>
					<input type="text" class="form-control col-12" id="titulo" name="titulo" value="{{$livro->titulo}}" aria-describedby="titleHelp" required>
					<small id="titleHelp" class="form-text text-muted">Defina o título para seu livro.</small>
				</div>
				<div class="form-group">
					<label for="descricao">Descrição:</label>
					<input type="text" class="form-control col-12" id="descricao" name="descricao" value="{{$livro->descricao}}" aria-describedby="descricaoHelp" required>
